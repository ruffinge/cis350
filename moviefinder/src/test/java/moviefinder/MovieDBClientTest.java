...
public class MovieDBClientTest {
    ...
    public final void testSearchMovies() {
        MovieDBClient client = new MovieDBClient();
        String result = (client.searchMovies("saving private Ryan").get(0))
                .toString();
    ...
    public final void testSearchShows() {
        MovieDBClient client = new MovieDBClient();
        String result = (client.searchShows("game of thrones").get(0))
                .toString();
        String formattedResult = result.substring(0, result.length() - 7);
    ...
    public final void testSearchShows2() {
        MovieDBClient client = new MovieDBClient();
        String result = (client.searchShows("hell on wheels").get(0))
                .toString();
        String formattedResult = result.substring(0, result.length() - 7);
    ...
    public final void testSearchPeople() {
        ...
        MovieDBClient client = new MovieDBClient();
        String result = (client.searchPeople("steven spielberg").get(0))
                .toString();
    ...
    public final void testSearchPeople2() {
        ...
        MovieDBClient client = new MovieDBClient();
        String result = (client.searchPeople("quentin tarantino").get(0))
                .toString();
        String formattedResult = result.substring(0, result.length() - 6);
    ...
    public final void testGetDescription() {
        ...
        assertEquals(description, client.searchMovies("deadpool").get(0)
                .getOverview());
    }
    ...
    public final void testGetDescription2() {
        ...
        String description = client.getDescription(ex);
        assertEquals(description, client.searchMovies("Daredevil").get(0)
                .getOverview());
    }
